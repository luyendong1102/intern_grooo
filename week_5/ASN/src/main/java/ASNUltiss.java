 ...
 *
 */
public class ASNUltiss {

    private static final Map<String, String> oidToNameMapping = new HashMap<>();
    static {
    ...
    public static String getName(String id) {
        return oidToNameMapping.get(id);
    }

    public static String getName(ASN1ObjectIdentifier objectIdentifer) {
        String id = objectIdentifer.getId();
        String name = oidToNameMapping.get(id);
